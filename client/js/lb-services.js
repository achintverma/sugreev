  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Tasks.account() instead.
        "::get::Tasks::account": {
    ...
    */
     ...
     * manipulating `Tasks` instances related to `Account`.
     *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Tasks.project() instead.
        "::get::Tasks::project": {
    ...
    */
     ...
     * manipulating `Tasks` instances related to `Project`.
     *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Tasks.activities.findById() instead.
        "prototype$__findById__activities": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/tasks/:id/activities/:fk",
          method: "GET"
        },

        // INTERNAL. Use Tasks.activities.destroyById() instead.
        ...
        // INTERNAL. Use Tasks.activities.updateById() instead.
        ...
        // INTERNAL. Use Tasks.activities() instead.
        "prototype$__get__activities": {
          isArray: true,
          url: urlBase + "/tasks/:id/activities",
          method: "GET"
        },

        // INTERNAL. Use Tasks.activities.create() instead.
        "prototype$__create__activities": {
          url: urlBase + "/tasks/:id/activities",
          method: "POST"
        },

        // INTERNAL. Use Tasks.activities.destroyAll() instead.
        "prototype$__delete__activities": {
          url: urlBase + "/tasks/:id/activities",
          method: "DELETE"
        },

        // INTERNAL. Use Tasks.activities.count() instead.
        "prototype$__count__activities": {
          url: urlBase + "/tasks/:id/activities/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Activity.tasks() instead.
        "::get::Activity::tasks": {
          url: urlBase + "/activities/:id/tasks",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Tasks";
        ...
        R.account = function() {
          ...
          var action = TargetResource["::get::Tasks::account"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks#project
         * @methodOf lbServices.Tasks
         *
         * @description
         *
        ...
        R.project = function() {
          ...
          var action = TargetResource["::get::Tasks::project"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Tasks.activities
     * @header lbServices.Tasks.activities
     * @object
     * @description
     *
     * The object `Tasks.activities` groups methods
     * manipulating `Activity` instances related to `Tasks`.
     *
     * Call {@link lbServices.Tasks#activities Tasks.activities()}
     * to query all related instances.
     */
        ...
        R.activities = function() {
          ...
          var action = TargetResource["::get::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#count
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
         * Counts activities of Tasks.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.activities.count = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::count::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#create
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.create = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::create::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#createMany
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.createMany = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::createMany::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#destroyAll
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.destroyAll = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::delete::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#destroyById
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.destroyById = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::destroyById::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#findById
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.findById = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::findById::Tasks::activities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Tasks.activities#updateById
         * @methodOf lbServices.Tasks.activities
         *
         * @description
         *
        ...
        R.activities.updateById = function() {
          var TargetResource = $injector.get("Activity");
          var action = TargetResource["::updateById::Tasks::activities"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Tasks.activities.createMany() instead.
        "::createMany::Tasks::activities": {
          isArray: true,
          url: urlBase + "/tasks/:id/activities",
          method: "POST"
        },
    ...
    */
    R.modelName = "Activity";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Activity#tasks
         * @methodOf lbServices.Activity
         *
         * @description
         *
         * Fetches belongsTo relation tasks.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.tasks = function() {
          var TargetResource = $injector.get("Tasks");
          var action = TargetResource["::get::Activity::tasks"];
          return action.apply(R, arguments);
        };
